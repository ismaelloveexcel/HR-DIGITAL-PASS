    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden transition-colors duration-500 font-sans bg-[#ffffffde] pt-[0px] pb-[0px] pl-[0px] pr-[0px]">
      ...
      <AnimatePresence mode="wait">
        {showVerification && (
          ...
          >
             <div className="w-full max-w-[340px] rounded-[32px] p-5 relative overflow-hidden shadow-[0_0_100px_rgba(44,65,172,0.4)] text-[#000000] max-h-[calc(100vh-32px)] overflow-y-auto no-scrollbar flex flex-col bg-[#ffffff]">
                {/* Close Button */}
                <button 
                ...
                <div className="flex flex-col items-center text-center pt-2 pb-2">
                   ...
                   <div className="mb-4 shrink-0">
                      <h3 className="text-[#193cb8] font-extrabold text-[20px]">{user.name}</h3>
